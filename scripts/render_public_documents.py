...
def fig_emission_model():
    ...
    levels = [("50", 144), ("25", 128), ("12.5", 112), ("6.25", 96), ("3.125", 80), ("1.5625", 64), ("0.78125", 50), ("0.390625", 40)]
    for reward, y in levels:
        d.add(Line(40, y, 48, y, strokeColor=colors.black, strokeWidth=1))
        d.add(String(4, y - 3, reward, fontName="Times-Roman", fontSize=7.5))
    heights = [
        ("0", 52),
        ("1.26M", 101),
        ("2.52M", 150),
    ...
    d.add(
        String(
            225,
            170,
            "50 -> 25 -> 12.5 -> 6.25 -> 3.125 -> 1.5625 -> 0.78125 -> 0.390625 ATHO tail",
            fontName="Times-Italic",
            fontSize=11,
            textAnchor="middle",
        )
    ...
    story.append(
        Paragraph(
            (
                ...
                "100-second target cadence with 1-confirmation normal transaction spendability, "
                "wallet-selected confirmation policy, and 100-block coinbase maturity. "
