...
"""Atho desktop startup launcher.

This module is startup-only glue. It never proxies consensus, validation,
networking, wallet, API, explorer, or mining hot paths. The small top-level
launcher wrappers verify/build the required binaries when needed and replace
