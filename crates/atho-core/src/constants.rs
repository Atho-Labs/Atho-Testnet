...
pub const NORMAL_TX_VALID_AFTER_CONFIRMATIONS: u64 = 1;
pub const DEFAULT_WALLET_MIN_CONFIRMATIONS: u64 = 3;
pub const DEFAULT_SAFE_CONFIRMATIONS: u64 = 6;
pub const HIGH_VALUE_CONFIRMATIONS: u64 = 20;
...
pub const MIN_OUTPUT_AMOUNT_ATOMS: u64 = 100;
...
pub const INITIAL_BLOCK_REWARD_ATOMS: u64 = 50 * ATOMS_PER_ATHO;
pub const TAIL_REWARD_ATOMS: u64 = 39_062_500;
