...
fn render_address_pool_tab(app: &mut DesktopApp, ui: &mut egui::Ui) {
    widgets::panel_frame().show(ui, |ui| {
        ...
        widgets::muted_label(
            ui,
            "Addresses here are the receive addresses already generated by this wallet. Used addresses are marked and hidden by default.",
        );
        ui.add_space(10.0);
        ...
        widgets::muted_label(
            ui,
            &format!("{total} address(es) total, {unused} unused, {used} used"),
        );
        ui.add_space(10.0);
