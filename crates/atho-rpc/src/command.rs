...
pub const COMMANDS: &[CommandDefinition] = &[
    ...
    CommandDefinition {
        name: "setminingrewardaddress",
        group: CommandGroup::Mining,
        description: "Set the running node's mining payout address for block templates.",
        usage: "setminingrewardaddress <address>",
        args_schema: "same-network Atho address",
        result_schema: "updated mining reward address object",
        permission: CommandPermission::LocalWrite,
        mainnet_allowed: true,
        wallet_required: false,
        auth_required: false,
        ...
        test_only: false,
        audit_log_required: true,
        examples: &["setminingrewardaddress T6AD..."],
    },
    CommandDefinition {
