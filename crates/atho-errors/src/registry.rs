...
descriptors! {
    ...
    CONS_MONETARY_SUPPLY_EXCEEDED => ("ATHO-CONS-003", Consensus, Critical, false, true, "Monetary Supply Exceeded", "Applying this block would exceed Atho's configured maximum supply.", "The coinbase reward or fee accounting is invalid.", "Recalculate subsidy and fee distribution for the candidate block."),
    ...
    MEM_DUST_OUTPUT => ("ATHO-MEM-002", Mempool, Error, true, false, "Dust Output Rejected", "The transaction creates an output below Atho's relay dust floor.", "A wallet or sender attempted to create an output smaller than the 50-atom relay minimum.", "Raise every spendable output to at least 50 atoms or combine the value into fees."),
